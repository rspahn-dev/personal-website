...
const DEFAULT_CONTENT = {
  sections: {
    about: [
      ...
      "This space highlights the projects, writing, and collaborations that mean the most to me. Thanks for visiting—feel free to explore and reach out!",
    ].join("\n\n"),
    portfolioIntro:
...
function renderBlogPosts(posts) {
  ...
  posts
    ...
    .forEach((post) => {
      ...
      meta.textContent = `${statusText} • Tags: ${tags}`;
